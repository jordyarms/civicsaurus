...
const config: Config = {
  ...
  url: 'https://civicsaurus.vercel.app',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/jordyarms/civicsaurus/tree/main/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} TO BE UPDATED. Built with Docusaurus.`,
    },
    prism: {
